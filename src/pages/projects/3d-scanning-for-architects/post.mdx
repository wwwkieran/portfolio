...
short_description: "How can photogrammetry be used as a tool for digital sketching in 3D?"
long_description: "How can photogrammetry be used as a tool for digital sketching in 3D? In this project, I use photogrammetry combined with human gesture to develop a sculptural form for an entryway to Kent Hall at Columbia University."

info: "Summer Project at Columbia GSAPP"
link: ""
tech: "Photogrammetry, Rhino, Illustrator"
index: 5
---
...
<FlexContainer>
    <ThirdWidth>
        ...
        While a typical architectural design process might involve creating 2D sketches and building 3D models off of them, I wanted to experiment with sketching directly in 3D.
    </ThirdWidth>
    <ThirdWidth>
...
<FlexContainer>
    <ThirdWidth>
        ...
        My goal was to build a sculptural entryway and addition to the East Asian Library in Kent Hall, enabling direct access from Amsterdam Ave.
    </ThirdWidth>
    <ThirdWidth>
...
<FlexContainer>
    <ThirdWidth>
        Using Rhino, I inserted the form in my site model and transformed it to meet site requirements.
    </ThirdWidth>
    <ThirdWidth>
