...
<FlexContainer>
    <ThirdWidth>
        Photogrammetry is a computational process whereby photos of an object taken from different angles can be used to reconstruct digital 3D model of the object.
    ...
    <ThirdWidth>
       photogrammetry diagram goes here
    </ThirdWidth>
</FlexContainer>
